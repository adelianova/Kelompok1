...
public class PakaianAdapter extends RecyclerView.Adapter<PakaianAdapter.ViewHolder> {
    ...
    ArrayList<PakaianModel> hotelList;

    public PakaianAdapter(Context context, ArrayList<PakaianModel> hotelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_pakaian, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        PakaianModel hotel = hotelList.get(position);
