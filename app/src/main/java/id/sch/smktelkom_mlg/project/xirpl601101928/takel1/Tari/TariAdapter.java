 ...
 */
public class TariAdapter extends RecyclerView.Adapter<TariAdapter.ViewHolder> {
    IHotelAdapter mIHotelAdapter;
    ArrayList<TariModel> hotelList;

    public TariAdapter(Context context, ArrayList<TariModel> hotelList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        TariModel hotel = hotelList.get(position);
