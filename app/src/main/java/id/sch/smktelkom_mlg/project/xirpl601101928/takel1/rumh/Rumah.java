 ...
 */
public class Rumah extends AppCompatActivity implements RumahAdapter.IHotelAdapter {
    public static final String HOTEL = "hotel";
    public static final int REQUEST_CODE_ADD = 88;
    public static final int REQUEST_CODE_EDIT = 99;
    ArrayList<RumahModel> mList = new ArrayList<>();
    RumahAdapter mAdapter;
    int itemPos;
    ArrayList<RumahModel> mListALL = new ArrayList<>();
    boolean isfiltered;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_ADD && resultCode == RESULT_OK) {
            RumahModel hotel = (RumahModel) data.getSerializableExtra(HOTEL);
            mList.add(hotel);
    ...
    private void fillData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.rumah_judul);
        String[] arDescripsi = resources.getStringArray(R.array.rumah_desk);
        String[] arDetail = resources.getStringArray(R.array.Rumah_detail);
        TypedArray a = resources.obtainTypedArray(R.array.rumah_picture);
        ...
        for (int i = 0; i < arJudul.length; i++) {
            mList.add(new RumahModel(arJudul[i], arDescripsi[i],
                    arFoto[i], arDetail[i]));
        }
        mAdapter.notifyDataSetChanged();
    }
    ...
    private void doFilter(String mQuery) {
        ...
        if (mQuery == null || mQuery.isEmpty()) {
            ...
            for (int i = 0; i < mListALL.size(); i++) {
                RumahModel hotel = mListALL.get(i);
